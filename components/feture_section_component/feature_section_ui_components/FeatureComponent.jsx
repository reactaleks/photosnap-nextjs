...
export default function Feature({icon, iconWidth, iconHeight, title, description}) {
    return (
        <div className="w-[310px] h-[236px] flex flex-col justify-between items-center my-6">
            <div className="w-[72px] h-[72px]"><Image src={icon} width={iconWidth} height={iconHeight} alt=""/> </div>
